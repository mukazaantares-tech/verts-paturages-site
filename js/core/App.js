...
=============================== */
    ...
    sidebarItems.forEach((item) => {
      item.addEventListener("click", () => {
        ...
        if (
          ...
          setTimeout(() => {
            LocalisationModule.map?.invalidateSize();
          }, 200);
        }
      });
    });
  ...
  if (typeof AdhesionsModule !== "undefined") AdhesionsModule.init();

  if (typeof ProgrammeModule !== "undefined") ProgrammeModule.init();

  if (typeof InstructionsModule !== "undefined") InstructionsModule.init();

  if (typeof CouplesModule !== "undefined") CouplesModule.init();

  if (typeof ReportsModule !== "undefined") ReportsModule.init();

  if (typeof AdminsModule !== "undefined") AdminsModule.init();

  if (typeof SettingsModule !== "undefined") SettingsModule.init();

  if (typeof DepartementsModule !== "undefined") DepartementsModule.init();

  if (typeof VersesModule !== "undefined") VersesModule.init();

  if (typeof LocalisationModule !== "undefined") LocalisationModule.init();
  ...
  if (typeof YouthCommentsPublic !== "undefined") YouthCommentsPublic.init();

  if (typeof YouthCommentsAdmin !== "undefined") YouthCommentsAdmin.init();

  if (typeof YouthPublic !== "undefined") YouthPublic.init();

  if (typeof YouthActivitiesPublic !== "undefined")
    YouthActivitiesPublic.init();

  if (typeof DepartementsPublic !== "undefined") DepartementsPublic.init();
  ...
  if (typeof AccueilModule !== "undefined") AccueilModule.init();

  if (typeof VersesPublic !== "undefined") VersesPublic.init();

  if (typeof TopbarModule !== "undefined")
    console.log("TopbarModule chargé") || TopbarModule.init();
